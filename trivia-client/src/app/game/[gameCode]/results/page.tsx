              ...
              return (
                ...
                >
                  <div className="flex items-center">
                    <span className={`${rankColor} font-bold text-xl mr-3`}>#{index + 1}</span>
                    <span className="text-lg">{medal}{player.name}</span>
                  </div>
                  <span className="text-lime-400 font-bold text-xl">{player.score} pts</span>
                </motion.li>
              );
            })}
          </ul>
